...
def get_tf_cpu():
    return tuple(birads_prediction_tf.inference({
...
def get_torch_cpu():
    return tuple(birads_prediction_torch.inference({
...
def test_tf_torch_equal():
    assert np.allclose(get_tf_cpu(), get_torch_cpu())
